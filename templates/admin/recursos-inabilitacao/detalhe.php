...
$recursoLabel = sprintf(__('Recurso #%d', 'participe-ibram'), (int) $recurso->id());
...
PageLayout::open(
    ...
    [
        ...
        ['label' => __('Recursos de inabilitação', 'participe-ibram'), 'url' => $listaUrl],
        ['label' => $recursoLabel],
    ]
);
?>
...
<div class="pi-recurso-grid">
    <main id="pi-decisao-main" class="pi-recurso-grid__main" tabindex="-1">
        ...
        <section id="pi-decisao-form" class="pi-card" aria-labelledby="recurso-decisao-title">
            ...
            <div class="pi-card__body pi-form">
                <form method="post" action="" data-pi-decisao-form="recurso-inabilitacao">
                    ...
                    <fieldset class="pi-field-group">
                        <legend class="pi-field-group__label"><?php esc_html_e('Qual é a sua decisão?', 'participe-ibram'); ?></legend>
                    ...
                    <div class="pi-field-group">
                        <label for="decisao-md" class="pi-field-group__label pi-field-group__label--required">
                    ...
                    <div class="pi-form-actions">
                        <button type="submit" class="pi-button pi-button--primary" data-pi-confirm-decisao>
                            <?php esc_html_e('Decidir', 'participe-ibram'); ?>
                        </button>
                        <a class="pi-button pi-button--secondary" href="<?php echo esc_url($listaUrl); ?>">
...
<div id="pi-confirm-decisao" class="pi-modal" role="dialog" aria-modal="true"
    ...
    <div class="pi-modal__dialog">
        ...
        <div class="pi-modal__actions">
            <button type="button" class="pi-button pi-button--secondary" data-pi-modal-cancel>
                <?php esc_html_e('Cancelar', 'participe-ibram'); ?>
            </button>
            <button type="button" class="pi-button pi-button--primary" data-pi-modal-confirm>
