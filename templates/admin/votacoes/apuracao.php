...
?>
<div class="participe-ibram-scope wrap pi-admin-apuracao" data-pi-apuracao>
  ...
  <header>
    ...
    <a href="<?php echo esc_url(VotacaoMenuRegistry::urlAuditoria((int) $votacao->id())); ?>" class="page-title-action">
      <?php esc_html_e('Auditoria', 'participe-ibram'); ?>
    </a>
  </header>
  ...
  <nav class="pi-breadcrumb" aria-label="<?php esc_attr_e('Você está em', 'participe-ibram'); ?>">
    <ol class="pi-breadcrumb__list">
      <li class="pi-breadcrumb__item">
        <a href="<?php echo esc_url(VotacaoMenuRegistry::urlVotacoesList()); ?>">
          <?php esc_html_e('Votações', 'participe-ibram'); ?>
        </a>
      </li>
      <li class="pi-breadcrumb__item" aria-current="page">
        <?php esc_html_e('Apurar', 'participe-ibram'); ?>
      </li>
    </ol>
  </nav>
  ...
  <main id="pi-admin-main" tabindex="-1">
    ...
    <section class="pi-card pi-apuracao__hash" aria-labelledby="pi-apuracao-hash-heading">
      ...
      <?php else : ?>
        ...
        <div class="pi-card__actions">
          <button type="button" class="button button-secondary" data-pi-copy="<?php echo esc_attr($hash); ?>">
    ...
    <?php if ($resultadosTable !== null) : ?>
      <section class="pi-card pi-apuracao__resultados" aria-labelledby="pi-apuracao-resultados-heading">
    ...
    <div id="pi-modal-apurar" class="pi-modal" role="dialog" aria-modal="true"
      ...
      <div class="pi-modal__panel pi-modal--warning" role="document">
        ...
        <div class="pi-modal__actions">
          <button type="button" class="button button-secondary" data-pi-modal-close><?php esc_html_e('Cancelar', 'participe-ibram'); ?></button>
          <button type="button" class="button button-primary" data-pi-modal-confirm="apurar"><?php esc_html_e('Sim, apurar', 'participe-ibram'); ?></button>
        </div>
      </div>
    </div>
    ...
    <div id="pi-modal-publicar" class="pi-modal" role="dialog" aria-modal="true"
      ...
      <div class="pi-modal__panel" role="document">
        ...
        <div class="pi-modal__actions">
          <button type="button" class="button button-secondary" data-pi-modal-close><?php esc_html_e('Cancelar', 'participe-ibram'); ?></button>
          <button type="button" class="button button-primary" data-pi-modal-confirm="publicar"><?php esc_html_e('Sim, publicar', 'participe-ibram'); ?></button>
        </div>
      </div>
    </div>
