...
?>
<div class="participe-ibram-scope wrap pi-inscricao-detalhes" data-pi-inscricao-detalhes>
  ...
  <nav class="pi-breadcrumb" aria-label="<?php esc_attr_e('Você está em', 'participe-ibram'); ?>">
    <ol class="pi-breadcrumb__list">
      <li class="pi-breadcrumb__item">
        <a href="<?php echo esc_url($listaUrl); ?>"><?php esc_html_e('Habilitações', 'participe-ibram'); ?></a>
      </li>
      <li class="pi-breadcrumb__item" aria-current="page">
        <?php echo esc_html(sprintf(__('Inscrição #%d', 'participe-ibram'), (int) $inscricao->id())); ?>
      </li>
    </ol>
  </nav>
  ...
  <div class="pi-inscricao-detalhes__actions" role="group"
    ...
    <?php if ($podeHabilitar) : ?>
      <button type="button" class="button button-primary pi-btn--habilitar"
    ...
    <?php if ($podeInabilitar) : ?>
      <button type="button" class="button pi-btn--inabilitar"
  ...
  <div class="pi-modal" id="pi-modal-habilitar" role="dialog" aria-modal="true"
    ...
    <div class="pi-modal__dialog">
      ...
      <footer class="pi-modal__footer">
        <button type="button" class="button" data-pi-modal-close>
          <?php esc_html_e('Cancelar', 'participe-ibram'); ?>
        </button>
        <button type="button" class="button button-primary" data-pi-confirm="habilitar"
  ...
  <div class="pi-modal" id="pi-modal-inabilitar" role="dialog" aria-modal="true"
    ...
    <div class="pi-modal__dialog">
      ...
      <footer class="pi-modal__footer">
        ...
        <button type="button" class="button" data-pi-confirm="inabilitar"
                data-inscricao-id="<?php echo esc_attr((string) $inscricao->id()); ?>"
