...
$recursoTitle = sprintf(
    ...
    __('Recurso #%d — Presidência (final)', 'participe-ibram'),
    (int) $recurso->id()
);
...
PageLayout::open(
    ...
    [
        ...
        ['label' => __('Recursos — Presidência', 'participe-ibram'), 'url' => esc_url($listaUrl)],
...
<div class="pi-recurso-grid">
  <main id="pi-decisao-main" class="pi-recurso-grid__main" tabindex="-1">
    ...
    <section id="pi-decisao-form" class="pi-card" aria-labelledby="pres-decisao-title">
      ...
      <div class="pi-card__body">
        <form method="post" action="" class="pi-form" data-pi-decisao-form="presidencia">
