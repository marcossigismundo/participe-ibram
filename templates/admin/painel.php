<?php
/**
 * Template — Painel (Visão Geral) do Participe Ibram (Onda 11-A / W11-B).
 *
 ...
 * W11-B: inline <style> removido — CSS compilado em participe-ibram-admin.css
 *        (_painel.scss). Breadcrumb usa PageLayout::breadcrumbs().
 *
