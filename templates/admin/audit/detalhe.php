...
?>
<div class="participe-ibram-scope wrap pi-admin-audit pi-admin-audit--detalhe">
  ...
  <header role="banner">
    <h1>
      ...
      printf(
          ...
          esc_html__('Detalhe do registro de auditoria #%d', 'participe-ibram'),
          $recordId
      );
      ?>
    </h1>
  ...
  <nav class="pi-breadcrumb" aria-label="<?php esc_attr_e('Você está em', 'participe-ibram'); ?>">
    <ol class="pi-breadcrumb__list">
      ...
      <li class="pi-breadcrumb__item" aria-current="page">
        <?php echo esc_html(sprintf(__('Registro #%d', 'participe-ibram'), $recordId)); ?>
      </li>
    </ol>
  </nav>
