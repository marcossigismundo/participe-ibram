<?php
/**
 * Template — Admin Dashboard Participe Ibram (Wave 7 — replaces W3-D stub).
 *
 ...
 *  - 1.1.1 Non-text Content: every chart has <figure>/<figcaption> + accessible table toggle
 *  - 1.3.1 Info and Relationships: semantic <table> with <caption>/<th scope>
 *  - 2.1.1 Keyboard: toggle buttons fully keyboard operable
 *  - 2.4.1 Bypass Blocks: skip link
 *  - 4.1.3 Status Messages: aria-live="polite" on KPI grid and status bar
 *
...
?>
<div class="participe-ibram-scope wrap pi-dashboard">
  <a class="pi-skip-link" href="#pi-dash-main"><?php esc_html_e('Pular para o conteúdo', 'participe-ibram'); ?></a>

  <header class="pi-dash__header" role="banner">
    <div class="pi-dash__header-inner">
      <h1 class="pi-dash__title">
        <?php esc_html_e('Dashboard — Participe Ibram', 'participe-ibram'); ?>
      </h1>
    ...
    <div class="pi-dash__header-actions">
      <button type="button"
              id="pi-dash-refresh"
  ...
  <main id="pi-dash-main" tabindex="-1">
    ...
    <?php /* ── Row 4: Top 10 estados (replaces complex SVG map) ──────── */ ?>
...
<?php
// Enqueue dashboard script if not already done.
