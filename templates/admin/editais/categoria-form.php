...
PageLayout::open(
    ...
    [
        ...
        ['label' => esc_html($edital->titulo()), 'url' => EditalMenuRegistry::urlEditalDetalhes($editalId)],
        ['label' => $pageTitle],
    ]
);
?>
...
<main id="pi-admin-main" tabindex="-1">
    <?php if (!$podeEditar) : ?>
        <?php Notice::warning(__('Este edital não permite edição de categorias no status atual.', 'participe-ibram')); ?>
    <?php else : ?>
    <form method="post" action="<?php echo esc_url(admin_url('admin.php')); ?>" novalidate aria-label="<?php esc_attr_e('Formulário de categoria', 'participe-ibram'); ?>" class="pi-form">
        ...
        <div class="pi-field-group">
            <label for="pi-cat-nome" class="pi-field-group__label pi-field-group__label--required">
        ...
        <!-- Descrição -->
        <div class="pi-field-group">
            <label for="pi-cat-descricao" class="pi-field-group__label">
        ...
        <div class="pi-form-row">
            <div class="pi-field-group">
                <label for="pi-cat-vagas" class="pi-field-group__label pi-field-group__label--required">
            ...
            <div class="pi-field-group">
                <label for="pi-cat-suplentes" class="pi-field-group__label">
        ...
        <fieldset class="pi-field-group">
            <legend class="pi-field-group__label pi-field-group__label--required">
        ...
        <!-- Critérios (Markdown) -->
        <div class="pi-field-group">
            <label for="pi-cat-criterios" class="pi-field-group__label">
        ...
        <!-- Ordem -->
        <div class="pi-field-group">
            <label for="pi-cat-ordem" class="pi-field-group__label"><?php esc_html_e('Ordem de exibição', 'participe-ibram'); ?></label>
            <input
                type="number"
                id="pi-cat-ordem"
                name="ordem"
        ...
        <div class="pi-form-actions">
            ...
            <a href="<?php echo esc_url(EditalMenuRegistry::urlEditalDetalhes($editalId)); ?>" class="pi-button pi-button--secondary">
