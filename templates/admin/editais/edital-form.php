...
?>
<div class="participe-ibram-scope wrap pi-admin-edital-form" data-pi-edital-form>
  ...
  <main id="pi-admin-main" tabindex="-1">
    ...
    <div class="pi-form-layout">
      <!-- Coluna principal -->
      <div class="pi-form-layout__main">
        <form method="post" action="<?php echo esc_url(admin_url('admin.php')); ?>" novalidate aria-label="<?php esc_attr_e('Formulário do edital', 'participe-ibram'); ?>">
          ...
          <!-- Título -->
          <div class="pi-form-field <?php echo isset($errors['titulo']) ? 'pi-form-field--error' : ''; ?>">
            <label for="pi-titulo" class="pi-form-label pi-form-label--required">
            ...
            <?php if (isset($errors['titulo'])) : ?>
              <p id="pi-titulo-error" class="pi-field-error" role="alert"><?php echo esc_html($errors['titulo']); ?></p>
            <?php endif; ?>
          </div>

          <!-- Descrição (Markdown) -->
          <div class="pi-form-field">
            <label for="pi-descricao" class="pi-form-label">
          ...
          <!-- Datas -->
          <fieldset class="pi-dates-fieldset" aria-describedby="pi-dates-legend-hint">
            <legend class="pi-form-section-title"><?php esc_html_e('Programação de datas', 'participe-ibram'); ?></legend>
            ...
            ?>
            <div class="pi-form-field pi-form-field--date <?php echo $hasError ? 'pi-form-field--error' : ''; ?>">
              <label for="<?php echo esc_attr($fieldId); ?>" class="pi-form-label">
              ...
              >
              <?php if ($hasError) : ?>
                <p id="<?php echo esc_attr($fieldId . '-error'); ?>" class="pi-field-error" role="alert">
          ...
          <div class="pi-form-actions">
            ...
            <a href="<?php echo esc_url(EditalMenuRegistry::urlEditaisList()); ?>" class="button button-secondary">
...
<?php wp_enqueue_script('pi-edital-form'); ?>
